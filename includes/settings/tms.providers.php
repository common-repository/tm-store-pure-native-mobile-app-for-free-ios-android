...
* to 'plugins/wordpress-tm-store/hybridauth/Hybrid/Providers/XING.php' and then add it to 
* $WORDPRESS_TM_STORE_PROVIDERS_CONFIG :
*
*   ARRAY( 
...
*      'default_network'     : If true, it will shows up by default on Admin > TM Store > Networks
...
* configuration pages (wp-admin/options-general.php?page=wordpress-tm-store).
*/
...
$WORDPRESS_TM_STORE_PROVIDERS_CONFIG = ARRAY(
	ARRAY( 
